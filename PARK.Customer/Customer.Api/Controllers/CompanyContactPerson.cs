...
namespace Customer.Api.Controllers
{
    ...
    [ApiVersion("1.0")]
    public class CompanyContactPerson : CrudStampController<TestResponse,Domain.Entities.CompanyContactPerson, Guid, CompanyContactPersonModel, CompanyContactPersonFilter>
    {
